...
def _add_service_parser(subparsers):
    ...
    create_parser.add_argument('-ex', '--expose', help='Ports to private, e.g. 5000/tcp', action='append', type=int)
    ...
    run_parser.add_argument('-ex', '--expose', help='Ports to private, e.g. 5000/tcp', action='append', type=int)
